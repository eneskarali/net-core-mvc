...
namespace CourseManagementSystem.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(IAccountRepository accountRepository, ICourseRepository courseRepository)
        {
        ...
        public async Task<IActionResult> Profile()
        {
            ...
            var joinedCourses = _courseRepository.GetUserCourses(user.Id);

            var ownCourses = _courseRepository.GetUserOwnCourses(user.Id);

            ViewBag.ownCourseCount = ownCourses.Count;
            ViewBag.joinedCourseCount = joinedCourses.Count;
